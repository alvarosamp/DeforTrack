...
all masks would be retained. A confidence-weighted mean requires an additional threshold selected on validation data, whereas Boolean OR directly implements the geometric union of same-class forest instances.}
...
\color{red}
\centering
\caption{Ablation of instance-mask fusion rules on the 892-image final test partition using Mask R-CNN ResNet-101 FPN 3x.}
